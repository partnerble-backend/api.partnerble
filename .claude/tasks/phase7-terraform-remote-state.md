...
aws ecr get-login-password --region ap-northeast-2 | \
  ...
  REPLACE_WITH_AWS_ACCOUNT_ID.dkr.ecr.ap-northeast-2.amazonaws.com

docker build -t partnerble-api .
docker tag partnerble-api:latest \
  REPLACE_WITH_AWS_ACCOUNT_ID.dkr.ecr.ap-northeast-2.amazonaws.com/partnerble-prod-api:latest
docker push REPLACE_WITH_AWS_ACCOUNT_ID.dkr.ecr.ap-northeast-2.amazonaws.com/partnerble-prod-api:latest
```
...
- **AWS 계정 ID:** `REPLACE_WITH_AWS_ACCOUNT_ID`
- **리전:** `ap-northeast-2`
