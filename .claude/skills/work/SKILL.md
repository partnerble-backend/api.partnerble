---
name: work
description: Start a new work session — takes Feature ID, reads Google Drive spec, creates base branch and auto-generates task files
---
...
**분리 기준:**
- 하나의 task는 단일 관심사를 다룬다 (모듈 1개, 엔드포인트 1개, 스키마 변경 1건 등)
